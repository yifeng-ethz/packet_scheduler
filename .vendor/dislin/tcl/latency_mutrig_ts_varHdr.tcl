...
for {set i 1} {[expr $i <= 9]} {incr i} {
    # 0.1) read file 
    set dly [expr ${i}*100]
    set fd0 [open "/home/yifeng/packages/online_dpv2/online/fe_board/fe_scifi/records/ingress_mask03_varHdrDelay/delay${dly}.txt"]
...
Dislin::setpag da4p
Dislin::metafl cons
Dislin::setfil "plot_packet_latency_ingress_varHdrDelay.pdf"
Dislin::disini 
Dislin::pagera 
Dislin::complx 
#Dislin::ticks  1 x
