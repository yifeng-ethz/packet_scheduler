...
for {set i 1} {[expr $i < 8]} {incr i} {
    # 0.1) read file 
    set fd0 [open "/home/yifeng/packages/online_dpv2/online/fe_board/fe_scifi/records/filllevel_ringcam/cam-0_inj-hdr_rate-${i}_delay-100.txt"]
...
Dislin::setpag da4p
Dislin::metafl cons
Dislin::setfil "./plot/plot_filllevel_rate_cam-0.pdf"
Dislin::disini 
Dislin::pagera 
Dislin::complx 
#Dislin::ticks  1 x
...
for {set i 1} {$i < 8} {incr i} {
    set rate [expr $i]
    Dislin::leglin $cbuf "rate = ${rate}" $i
