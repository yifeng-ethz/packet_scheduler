...
for {set i 1} {[expr $i < 8]} {incr i} {
    # 0.1) read file 
    set fd0 [open "/home/yifeng/packages/online_dpv2/online/fe_board/fe_scifi/records/egress_mask03_varHdrDelay/rate_${i}_delay_100.txt"]
...
Dislin::setpag da4p
Dislin::metafl cons
Dislin::setfil "plot_packet_latency_rate_egress.pdf"
Dislin::disini 
Dislin::pagera 
Dislin::complx 
#Dislin::ticks  1 x
...
for {set i 1} {$i < 8} {incr i} {
    set rate [expr $i]
    Dislin::leglin $cbuf "egress rate = ${rate}" $i
