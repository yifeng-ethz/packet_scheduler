...
- **Scenario:** Short frame, cluster-domain family, burst emulator traffic, nominal load band. The emulator is the only pre-run programmed block; the FEB chain must stay lossless through stage D.
...
| ℹ️ | log | [`uvm/logs/PROF_TBINT_118_SCB1_longrun_s1.log`](../../uvm/logs/PROF_TBINT_118_SCB1_longrun_s1.log) |
| ℹ️ | ucdb | [`uvm/cov_after/PROF_TBINT_118_SCB1_s1.ucdb`](../../uvm/cov_after/PROF_TBINT_118_SCB1_s1.ucdb) |
...
| ℹ️ | log.stage_b_hits | `49` |
| ℹ️ | log.stage_c_hits | `49` |
| ℹ️ | log.stage_d_hits | `49` |
...
ℹ️ See [`../txn_growth/PROF_TBINT_118_SCB1.md`](../txn_growth/PROF_TBINT_118_SCB1.md) for the log-spaced coverage curve.
