...
- **Scenario:** Long frame, cluster-domain family, burst emulator traffic, sparse load band. The emulator is the only pre-run programmed block; the FEB chain must stay lossless through stage D.
...
| ℹ️ | log | [`uvm/logs/PROF_TBINT_053_LCB0_longrun_s1.log`](../../uvm/logs/PROF_TBINT_053_LCB0_longrun_s1.log) |
| ℹ️ | ucdb | [`uvm/cov_after/PROF_TBINT_053_LCB0_s1.ucdb`](../../uvm/cov_after/PROF_TBINT_053_LCB0_s1.ucdb) |
| ℹ️ | log.b_contract_err | `0` |
| ℹ️ | log.c_contract_err | `0` |
| ℹ️ | log.d_contract_err | `0` |
| ℹ️ | log.e_contract_err | `0` |
| ℹ️ | log.elapsed | `0:05:38` |
...
| ℹ️ | log.stage_b_hits | `26` |
| ℹ️ | log.stage_c_hits | `26` |
| ℹ️ | log.stage_d_hits | `26` |
| ℹ️ | log.stage_e_hits | `20` |
...
ℹ️ See [`../txn_growth/PROF_TBINT_053_LCB0.md`](../txn_growth/PROF_TBINT_053_LCB0.md) for the log-spaced coverage curve.
