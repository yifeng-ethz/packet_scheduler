...
- **Scenario:** Short frame, cluster-domain family, Poisson emulator traffic, sparse load band. The emulator is the only pre-run programmed block; the FEB chain must stay lossless through stage D.
...
| ℹ️ | log | [`uvm/logs/PROF_TBINT_113_SCP0_longrun_s1.log`](../../uvm/logs/PROF_TBINT_113_SCP0_longrun_s1.log) |
| ℹ️ | ucdb | [`uvm/cov_after/PROF_TBINT_113_SCP0_s1.ucdb`](../../uvm/cov_after/PROF_TBINT_113_SCP0_s1.ucdb) |
| ℹ️ | log.b_contract_err | `0` |
| ℹ️ | log.c_contract_err | `0` |
| ℹ️ | log.d_contract_err | `0` |
| ℹ️ | log.e_contract_err | `0` |
| ℹ️ | log.elapsed | `0:04:57` |
...
| ℹ️ | log.stage_a_hits | `162` |
| ℹ️ | log.stage_b_hits | `45` |
| ℹ️ | log.stage_c_hits | `45` |
| ℹ️ | log.stage_d_hits | `45` |
| ℹ️ | log.stage_e_hits | `40` |
| ℹ️ | log.stage_h0_hits | `162` |
| ℹ️ | log.stage_h1_hits | `162` |
...
ℹ️ See [`../txn_growth/PROF_TBINT_113_SCP0.md`](../txn_growth/PROF_TBINT_113_SCP0.md) for the log-spaced coverage curve.
