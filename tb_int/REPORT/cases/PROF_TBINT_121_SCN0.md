...
- **Scenario:** Short frame, cluster-domain family, noise emulator traffic, sparse load band. The emulator is the only pre-run programmed block; the FEB chain must stay lossless through stage D.
...
| ℹ️ | log | [`uvm/logs/PROF_TBINT_121_SCN0_longrun_s1.log`](../../uvm/logs/PROF_TBINT_121_SCN0_longrun_s1.log) |
| ℹ️ | ucdb | [`uvm/cov_after/PROF_TBINT_121_SCN0_s1.ucdb`](../../uvm/cov_after/PROF_TBINT_121_SCN0_s1.ucdb) |
...
ℹ️ See [`../txn_growth/PROF_TBINT_121_SCN0.md`](../txn_growth/PROF_TBINT_121_SCN0.md) for the log-spaced coverage curve.
