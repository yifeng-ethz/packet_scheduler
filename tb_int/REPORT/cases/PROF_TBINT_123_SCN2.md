...
- **Scenario:** Short frame, cluster-domain family, noise emulator traffic, hot-safe load band. The emulator is the only pre-run programmed block; the FEB chain must stay lossless through stage D.
...
| ℹ️ | log | [`uvm/logs/PROF_TBINT_123_SCN2_longrun_s1.log`](../../uvm/logs/PROF_TBINT_123_SCN2_longrun_s1.log) |
| ℹ️ | ucdb | [`uvm/cov_after/PROF_TBINT_123_SCN2_s1.ucdb`](../../uvm/cov_after/PROF_TBINT_123_SCN2_s1.ucdb) |
...
| ℹ️ | log.stage_a_hits | `456` |
| ℹ️ | log.stage_b_hits | `136` |
| ℹ️ | log.stage_c_hits | `136` |
| ℹ️ | log.stage_d_hits | `136` |
| ℹ️ | log.stage_e_hits | `136` |
| ℹ️ | log.stage_h0_hits | `456` |
| ℹ️ | log.stage_h1_hits | `456` |
...
ℹ️ See [`../txn_growth/PROF_TBINT_123_SCN2.md`](../txn_growth/PROF_TBINT_123_SCN2.md) for the log-spaced coverage curve.
