...
| forced_ingress | frame_table_hit_aggregate | 0 | 1 | 0.224824 | 0.224824 | 0.224824 | 0.224824 |
...
| forced_ingress | late_drop_control_exact_hits | 0 | 1 | 0.898052 | 0.898052 | 0.931742 | 0.931742 |
| forced_ingress | late_drop_pa_action_hits | 0 | 1 | 0.898305 | 0.898305 | 0.931619 | 0.931619 |
| forced_ingress | pa_load_hits | 0 | 1 | 0.224824 | 0.224824 | 0.224824 | 0.224824 |
| forced_ingress | source_hits | 1 | 0 | 0 | 0 | 0 | 0 |
| forced_ingress | transaction_deliver_hits | 0 | 1 | 0.224824 | 0.224824 | 0.224824 | 0.224824 |
...
- `component_b000_rho0750_f0261_seed7101` `forced_ingress` `pa_load_hits`: first=f166 l1 shd101 rtl=58090 tlm=71150 agg_delta=0.22482355 bucket_delta=0.22482355
- `component_b000_rho0750_f0261_seed7101` `forced_ingress` `late_drop_pa_action_hits`: first=f168 l0 shd0 rtl=6844 tlm=696 agg_delta=0.89830508 bucket_delta=0.93161894
- `component_b000_rho0750_f0261_seed7101` `forced_ingress` `late_drop_control_exact_hits`: first=f137 l2 shd121 rtl=6827 tlm=696 agg_delta=0.89805185 bucket_delta=0.93174161
- `component_b000_rho0750_f0261_seed7101` `forced_ingress` `transaction_deliver_hits`: first=f166 l-1 shd101 rtl=58090 tlm=71150 agg_delta=0.22482355 bucket_delta=0.22482355
...
- `component_b000_rho0750_f0261_seed7101` `forced_ingress` `frame_table_hit_aggregate`: first=aggregate rtl=58090 tlm=71150 agg_delta=0.22482355 bucket_delta=0.22482355

## Run Metadata

- `component_b000_rho0750_f0261_seed7101`: frames=261 rho_ppm=750000 burst_milli=0 seed=0x5c1f0001 normal_events=547746 forced_events=610865
