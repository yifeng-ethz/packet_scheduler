# ✅ CORNER_OPQ_406_error_counter_clear_test
...
| status | field | value |
|:---:|---|---|
| ✅ | report_case_id | `CORNER_OPQ_406_error_counter_clear_test` |
| ℹ️ | legacy_test_name | `opq_error_counter_clear_test` |
| ℹ️ | observed_txn | `1` |
| ℹ️ | implementation_mode | `native_sv` |
| ℹ️ | log | [`uvm/logs/CORNER_OPQ_406_error_counter_clear_test_after_s1.log`](../../uvm/logs/CORNER_OPQ_406_error_counter_clear_test_after_s1.log) |
| ℹ️ | ucdb | [`uvm/cov_after/CORNER_OPQ_406_error_counter_clear_test_s1.ucdb`](../../uvm/cov_after/CORNER_OPQ_406_error_counter_clear_test_s1.ucdb) |
