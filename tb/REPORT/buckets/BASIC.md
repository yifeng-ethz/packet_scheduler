...
**Catalog planned:** `146` &nbsp; **Promoted:** `5` &nbsp; **Evidenced:** `5` &nbsp; **Catalog backlog:** `141` &nbsp; **Status:** ⚠️
...
| ✅ | 5 | `STD_OPQ_005_basic_single_active_lane_test` | `opq_basic_single_active_lane_test` | stmt=82.72, branch=70.18, cond=45.50, expr=69.09, fsm_state=85.71, fsm_trans=43.75, toggle=47.43 | [case](../cases/STD_OPQ_005_basic_single_active_lane_test.md) |
