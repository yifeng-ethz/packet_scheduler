...
proc my_generate { output_name } {
    ...
    set template_file "rtl/vhdl_ver/ordered_priority_queue/split/top/ordered_priority_queue_top.terp.vhd"
    ...
    add_fileset_file "opq_util_pkg.vhd" VHDL PATH "rtl/vhdl_ver/ordered_priority_queue/split/opq/common/opq_util_pkg.vhd"
    add_fileset_file "opq_sync_ram.vhd" VHDL PATH "rtl/vhdl_ver/ordered_priority_queue/split/opq/common/opq_sync_ram.vhd"
    add_fileset_file "opq_ingress_parser.vhd" VHDL PATH "rtl/vhdl_ver/ordered_priority_queue/split/opq/ingress/opq_ingress_parser.vhd"
    add_fileset_file "opq_page_allocator.vhd" VHDL PATH "rtl/vhdl_ver/ordered_priority_queue/split/opq/allocator/opq_page_allocator.vhd"
    add_fileset_file "opq_block_mover.vhd" VHDL PATH "rtl/vhdl_ver/ordered_priority_queue/split/opq/mover/opq_block_mover.vhd"
    add_fileset_file "opq_b2p_arbiter.vhd" VHDL PATH "rtl/vhdl_ver/ordered_priority_queue/split/opq/arbiter/opq_b2p_arbiter.vhd"
    add_fileset_file "opq_frame_table_mapper.vhd" VHDL PATH "rtl/vhdl_ver/ordered_priority_queue/split/opq/frame_table/opq_frame_table_mapper.vhd"
    add_fileset_file "opq_frame_table_tracker.vhd" VHDL PATH "rtl/vhdl_ver/ordered_priority_queue/split/opq/frame_table/opq_frame_table_tracker.vhd"
    add_fileset_file "opq_frame_table_presenter.vhd" VHDL PATH "rtl/vhdl_ver/ordered_priority_queue/split/opq/frame_table/opq_frame_table_presenter.vhd"
    add_fileset_file "opq_frame_table.vhd" VHDL PATH "rtl/vhdl_ver/ordered_priority_queue/split/opq/frame_table/opq_frame_table.vhd"
    add_fileset_file "opq_rd_debug_if.vhd" VHDL PATH "rtl/vhdl_ver/ordered_priority_queue/split/opq/debug/opq_rd_debug_if.vhd"
    add_fileset_file "opq_top.vhd" VHDL PATH "rtl/vhdl_ver/ordered_priority_queue/split/opq/top/opq_top.vhd"
